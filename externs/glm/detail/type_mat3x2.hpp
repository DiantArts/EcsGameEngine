...
public:
    ...
    GLM_FUNC_DECL tmat3x2(col_type const& v0, col_type const& v1, col_type const& v2);
    ...
    GLM_FUNC_DECL tmat3x2(tvec2<V1, P> const& v1, tvec2<V2, P> const& v2, tvec2<V3, P> const& v3);
