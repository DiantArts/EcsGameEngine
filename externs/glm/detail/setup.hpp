...
#if ((GLM_COMPILER & GLM_COMPILER_GCC) && (GLM_COMPILER <= GLM_COMPILER_GCC50)) ||                           \
    ((GLM_COMPILER & GLM_COMPILER_CLANG) && (GLM_COMPILER <= GLM_COMPILER_CLANG34))
...
#if ((GLM_COMPILER & GLM_COMPILER_GCC) && (GLM_COMPILER <= GLM_COMPILER_GCC48)) ||                           \
    ((GLM_COMPILER & GLM_COMPILER_CLANG) && (GLM_COMPILER <= GLM_COMPILER_CLANG33))
...
#define GLM_HAS_STATIC_ASSERT                                                                                \
    ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                                                     \
     (((GLM_COMPILER & GLM_COMPILER_GCC)) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) ||                         \
    ...
    ((GLM_LANG & GLM_LANG_CXX0X_FLAG) &&                                                                     \
     (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) ||                           \
      ((GLM_COMPILER & GLM_COMPILER_GCC) &&                                                                  \
       (GLM_COMPILER >=                                                                                      \
        GLM_COMPILER_GCC48)))) // GCC 4.6 support constexpr but there is a compiler bug causing a crash
#define GLM_HAS_CONSTEXPR_PARTIAL                                                                            \
    (GLM_HAS_CONSTEXPR || ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC14)))
#endif
