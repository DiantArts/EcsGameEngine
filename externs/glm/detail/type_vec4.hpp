...
#pragma GCC diagnostic pop
    ...
    /// Explicit converions (From section 5.4.1 Conversion and scalar constructors of GLSL 1.30.08
    /// specification)
    template <typename A, typename B, typename C, typename D>
    GLM_FUNC_DECL GLM_CONSTEXPR_SIMD tvec4(A a, B b, C c, D d);
    template <typename A, typename B, typename C, typename D>
    GLM_FUNC_DECL GLM_CONSTEXPR_CTOR tvec4(tvec1<A, P> const& a, tvec1<B, P> const& b, tvec1<C, P> const& c,
                                           tvec1<D, P> const& d);
    ...
    GLM_FUNC_DECL tvec4(detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const& v,
    ...
    template <int E0, int E1>
    GLM_FUNC_DECL tvec4(T const& x, detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const& v,
                        T const& w) {
        *this = tvec4<T, P>(x, v(), w);
    }

    template <int E0, int E1>
    GLM_FUNC_DECL tvec4(detail::_swizzle<2, T, P, glm::tvec2, E0, E1, -1, -2> const& v, T const& z,
                        T const& w) {
