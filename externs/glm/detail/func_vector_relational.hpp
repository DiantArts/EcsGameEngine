...
/// section 8.7 Vector Relational Functions</a>
///
...
/// @tparam vecType Floating-point or integer vector types.
///
/// @see <a href="http://www.opengl.org/sdk/docs/manglsl/xhtml/lessThanEqual.xml">GLSL lessThanEqual man
/// page</a>
/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification,
/// section 8.7 Vector Relational Functions</a>
template <typename T, precision P, template <typename, precision> class vecType>
...
/// /!\ Because of language incompatibilities between C++ and GLSL, GLM defines the function not but not_
/// instead.
///
/// @tparam vecType Boolean vector types.
///
