...
#define GLM_SWIZZLE_GEN_REF_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,             \
...
#define GLM_SWIZZLE_GEN_REF_FROM_VEC3(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                  \
                                      SWIZZLED_VEC3_TYPE)                                                    \
    GLM_SWIZZLE_GEN_REF_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, x, y, z)                                          \
    GLM_SWIZZLE_GEN_REF_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, r, g, b)                                          \
    GLM_SWIZZLE_GEN_REF_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, s, t, p)
...
#define GLM_SWIZZLE_GEN_REF_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,             \
...
#define GLM_SWIZZLE_GEN_REF_FROM_VEC4(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                  \
                                      SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE)                                \
    GLM_SWIZZLE_GEN_REF_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, x, y, z, w)                   \
    GLM_SWIZZLE_GEN_REF_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, r, g, b, a)                   \
    GLM_SWIZZLE_GEN_REF_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, s, t, p, q)
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC2_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,             \
                                           SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, A, B)                     \
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC2(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                  \
                                      SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE)                                \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC2_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, x, y)                         \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC2_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, r, g)                         \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC2_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, s, t)
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,             \
                                           SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, A, B, C)                  \
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC3(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                  \
                                      SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE)                                \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, x, y, z)                      \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, r, g, b)                      \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC3_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, s, t, p)
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,             \
                                           SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, A, B, C, D)               \
...
#define GLM_SWIZZLE_GEN_VEC_FROM_VEC4(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                  \
                                      SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE)                                \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, x, y, z, w)                   \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
                                       SWIZZLED_VEC3_TYPE, SWIZZLED_VEC4_TYPE, r, g, b, a)                   \
    GLM_SWIZZLE_GEN_VEC_FROM_VEC4_COMP(TMPL_TYPE, PRECISION, CLASS_TYPE, SWIZZLED_VEC2_TYPE,                 \
