...
/// section 4.1.3 Integers</a>
/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification,
/// section 4.7.2 Precision Qualifier</a>
...
#if (!defined(GLM_PRECISION_HIGHP_INT) && !defined(GLM_PRECISION_MEDIUMP_INT) &&                             \
     !defined(GLM_PRECISION_LOWP_INT))
typedef mediump_int int_t;
#elif (defined(GLM_PRECISION_HIGHP_INT) && !defined(GLM_PRECISION_MEDIUMP_INT) &&                            \
       !defined(GLM_PRECISION_LOWP_INT))
...
#if (!defined(GLM_PRECISION_HIGHP_UINT) && !defined(GLM_PRECISION_MEDIUMP_UINT) &&                           \
     !defined(GLM_PRECISION_LOWP_UINT))
typedef mediump_uint uint_t;
#elif (defined(GLM_PRECISION_HIGHP_UINT) && !defined(GLM_PRECISION_MEDIUMP_UINT) &&                          \
       !defined(GLM_PRECISION_LOWP_UINT))
