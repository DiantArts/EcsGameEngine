...
/// The first bit is the first bit of x followed by the first bit of y, the first bit of z and finally the
/// first bit of w. The other bits are interleaved following the previous sequence.
///
/// @see gtc_bitfield
