...
// template <typename T> GLM_FUNC_QUALIFIER tmat4x4<T, P> shear(const tmat4x4<T, P> & m, shearPlane,
// planePoint, angle)
// Identity + tan(angle) * cross(Normal, OnPlaneVector)     0
// - dot(PointOnPlane, normal) * OnPlaneVector              1

// Reflect functions seem to don't work
// template <typename T> tmat3x3<T, P> reflect2D(const tmat3x3<T, P> & m, const tvec3<T, P>& normal){return
// reflect2DGTX(m, normal);}									//!< \brief Build a reflection matrix (from
// GLM_GTX_transform2 extension) template <typename T> tmat4x4<T, P> reflect3D(const tmat4x4<T, P> & m, const
// tvec3<T, P>& normal){return reflect3DGTX(m, normal);}									//!< \brief Build
