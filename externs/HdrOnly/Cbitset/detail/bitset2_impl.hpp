...
protected:
  ...
  /* ----------------------------------------------------------------------- */
  constexpr
  Cbitset_impl() noexcept
  {}

  constexpr
  Cbitset_impl( Cbitset_impl const & ) noexcept= default;

  constexpr
  Cbitset_impl( Cbitset_impl && ) noexcept= default;

  constexpr
  Cbitset_impl &
  operator=( Cbitset_impl const & ) noexcept= default;

  constexpr
  Cbitset_impl &
  operator=( Cbitset_impl && ) noexcept= default;

  explicit
  constexpr
  Cbitset_impl( ULLONG_t v ) noexcept
...
public:
  ...
  constexpr
  bool
  operator==( Cbitset_impl const &v2 ) const noexcept
