...
#define START_COMPONENT_DECLARATIONS() \
    namespace engine::core::ecs::component::declaration::detail { \
...
#define DECLARE_COMPONENT(className) \
    class className; \
    template <> \
    class engine::core::ecs::component::declaration::detail::WithID<className> { \
    public: \
...
#define DECLARE_COMPONENT_IN_NAMESPACE(namespaceName, className) \
    ...
    template <> \
    class engine::core::ecs::component::declaration::detail::WithID<namespaceName::className> { \
    public: \
        [[ nodiscard ]] static inline constexpr ::std::size_t getID() { return m_id; } \
    private: \
        static constexpr auto m_id { __COUNTER__ - ::engine::core::ecs::component::declaration::detail::baseIDCounter }; \
    }

#define STOP_COMPONENT_DECLARATIONS() \
    namespace engine::core::ecs::component::declaration::detail { \
        constexpr const ::std::size_t numberOfIDs \
            { __COUNTER__ - ::engine::core::ecs::component::declaration::detail::baseIDCounter }; \
    } \
    class RandomAndTotallyUnexistantVarThatJustIsUsefulForTheSumicolon
